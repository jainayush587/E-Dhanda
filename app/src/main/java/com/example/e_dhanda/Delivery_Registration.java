...
public class Delivery_Registration extends AppCompatActivity {
    ...
    Button signup, Emailbtn, Phonebtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fname = (TextInputLayout)findViewById(R.id.DeliFirstname);
        Lname = (TextInputLayout)findViewById(R.id.DeliLastname);
        Email = (TextInputLayout)findViewById(R.id.DeliEmail);
        Pass = (TextInputLayout)findViewById(R.id.DeliPwd);
        cpass = (TextInputLayout)findViewById(R.id.DeliCpass);
        mobileno = (TextInputLayout)findViewById(R.id.DeliMobileNo);
        signup = (Button)findViewById(R.id.DeliSignup);
        Emailbtn = (Button)findViewById(R.id.DeliEmailBtn);
        Phonebtn = (Button)findViewById(R.id.DeliPhoneBtn);
