...
public class ChefRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fname = (TextInputLayout)findViewById(R.id.ChefFirstname);
        Lname = (TextInputLayout)findViewById(R.id.ChefLastname);
        Email = (TextInputLayout)findViewById(R.id.ChefEmail);
        Pass = (TextInputLayout)findViewById(R.id.ChefPwd);
        cpass = (TextInputLayout)findViewById(R.id.ChefCpass);
        mobileno = (TextInputLayout)findViewById(R.id.ChefMobileNo);


        signup = (Button)findViewById(R.id.ChefSignup);
        Emailbtn = (Button)findViewById(R.id.ChefEmailBtn);
        Phonebtn = (Button)findViewById(R.id.ChefPhoneBtn);
