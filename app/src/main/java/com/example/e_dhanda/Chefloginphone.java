...
public class Chefloginphone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        num = (EditText)findViewById(R.id.CPhoneNo);
        sendotp = (Button)findViewById(R.id.COtp);
        cpp=(CountryCodePicker)findViewById(R.id.CountryCode);
        signinemail=(Button)findViewById(R.id.ChefEmailBtn);
        signup = (TextView)findViewById(R.id.CCreateAcc);
